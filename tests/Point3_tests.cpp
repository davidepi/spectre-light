...
TEST(Point3,same_value_constructor)
{
    float val = 1.0f;
    Point3 p(val);
    EXPECT_EQ(p.x, val);
...
TEST(Point3,components_constructor)
{
...
TEST(Point3,distanceTo)
{
    Point3 p0(1,2,3);
    Point3 p1(4,5,6);
    float distance = p0.distanceTo(p1);
    EXPECT_FLOAT_EQ(distance, 5.1961524227f);
}
...
TEST(Point3,sum_vector)
{
    Point3 v1(1,2,3);
    Vec3 v2(4,5.5,-3);

    Point3 res = v1 + v2;
    EXPECT_FLOAT_EQ(res.x,5);
    EXPECT_FLOAT_EQ(res.y,7.5);
    EXPECT_FLOAT_EQ(res.z, 0.f);
}

TEST(Point3,sum_vector_this)
{
    Point3 v1(1,2,3);
    Vec3 v2(4,5.5,-3);
    ...
    EXPECT_FLOAT_EQ(v1.y,7.5);
    EXPECT_FLOAT_EQ(v1.z, 0.f);
}

TEST(Point3,sub_point)
{
    Point3 v1(1,2,3);
    Point3 v2(4,5.5,-3);
    Vec3 res = v2 - v1;
    EXPECT_FLOAT_EQ(res.x,3);
    EXPECT_FLOAT_EQ(res.y,3.5);
    EXPECT_FLOAT_EQ(res.z, -6);
}

TEST(Point3,sub_vector)
{
    Vec3 v1(1,2,3);
    Point3 v2(4,5.5,-3);
    Point3 res = v2 - v1;
...
TEST(Point3,sub_vector_this)
{
    Point3 v1(1,2,3);
    Vec3 v2(4,5.5,-3);
    v1-=v2;
    EXPECT_FLOAT_EQ(v1.x,-3);
    EXPECT_FLOAT_EQ(v1.y,-3.5);
    EXPECT_FLOAT_EQ(v1.z,6);
}
...
TEST(Point3,inline_distance)
{
    Point3 p0(1,2,3);
    Point3 p1(4,5,6);
    float dist = distance(p0,p1);
    EXPECT_FLOAT_EQ(dist, 5.1961524227f);
}

TEST(Point3,inline_max)
{
    Point3 sample(0.5,1.5,-3.5);
    Point3 value;
    Point3 compare;

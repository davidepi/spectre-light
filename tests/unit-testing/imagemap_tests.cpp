...
{
    const pixBGRA data[4] = {0xF94E47AFU, 0x2B196B67U, 0xECA970F6U, 0x12CDBB6BU};
...
SPECTRE_TEST(ImageMap, trilinear_mapping)
{
    ...
    const pixBGRA data[LEN] = {0x4E359DF3U, 0x6873B915U, 0x96E186E2U, 0x07D56734U};
    const TexelUnion* data_texel = (TexelUnion*)data;
    ...
    for(int i = 0; i<LEN;i++)
    {
        avgr += data_texel[i].bgra_texel.r;
        avgg += data_texel[i].bgra_texel.g;
        avgb += data_texel[i].bgra_texel.b;
        avga += data_texel[i].bgra_texel.a;
    }
    avgr *= INV;
    avgg *= INV;
    avgb *= INV;
    ...
    EXPECT_EQ(res.bgra_texel.r, (uint8_t)(data_texel[0].bgra_texel.r*.25f + avgr * .75f));
    EXPECT_EQ(res.bgra_texel.g, (uint8_t)(data_texel[0].bgra_texel.g*.25f + avgg * .75f));
    EXPECT_EQ(res.bgra_texel.b, (uint8_t)(data_texel[0].bgra_texel.b*.25f + avgb * .75f));
    EXPECT_EQ(res.bgra_texel.a, (uint8_t)(data_texel[0].bgra_texel.a*.25f + avga * .75f));
    res = map0.filter(0.75f, 0.25f, powf(2.f, -1.f/4.f), 0.f, 0.f, 0.f);
    EXPECT_EQ(res.bgra_texel.r, (uint8_t)(data_texel[1].bgra_texel.r*.25f + avgr * .75f));
    EXPECT_EQ(res.bgra_texel.g, (uint8_t)(data_texel[1].bgra_texel.g*.25f + avgg * .75f));
    EXPECT_EQ(res.bgra_texel.b, (uint8_t)(data_texel[1].bgra_texel.b*.25f + avgb * .75f));
    EXPECT_EQ(res.bgra_texel.a, (uint8_t)(data_texel[1].bgra_texel.a*.25f + avga * .75f));
    res = map0.filter(0.25f, 0.75f, powf(2.f, -1.f/4.f), 0.f, 0.f, 0.f);
    EXPECT_EQ(res.bgra_texel.r, (uint8_t)(data_texel[2].bgra_texel.r*.25f + avgr * .75f));
    EXPECT_EQ(res.bgra_texel.g, (uint8_t)(data_texel[2].bgra_texel.g*.25f + avgg * .75f));
    EXPECT_EQ(res.bgra_texel.b, (uint8_t)(data_texel[2].bgra_texel.b*.25f + avgb * .75f));
    EXPECT_EQ(res.bgra_texel.a, (uint8_t)(data_texel[2].bgra_texel.a*.25f + avga * .75f));
    res = map0.filter(0.75f, 0.75f, powf(2.f, -1.f/4.f), 0.f, 0.f, 0.f);
    EXPECT_EQ(res.bgra_texel.r, (uint8_t)(data_texel[3].bgra_texel.r*.25f + avgr * .75f));
    EXPECT_EQ(res.bgra_texel.g, (uint8_t)(data_texel[3].bgra_texel.g*.25f + avgg * .75f));
    EXPECT_EQ(res.bgra_texel.b, (uint8_t)(data_texel[3].bgra_texel.b*.25f + avgb * .75f));
    EXPECT_EQ(res.bgra_texel.a, (uint8_t)(data_texel[3].bgra_texel.a*.25f + avga * .75f));
...
SPECTRE_TEST(ImageMap, ewa_mapping)
{
    const int LEN = 4;
    constexpr const float INV = 1.f / LEN;
    const uint32_t data[LEN] = {0x43F40137U, 0x10CDBB7DU, 0x21F3C5D2U, 0x5F91ED48U};
    const TexelUnion* data_texel = (TexelUnion*)data;
    //avg used to represent farthest level
    float avgr = 0;
    float avgg = 0;

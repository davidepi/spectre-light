...
#line 12 "config_parser.y" // lalr1.cc:395
...
#line 53 "config_parser.tab.hh" // lalr1.cc:395
...
namespace yy {
#line 137 "config_parser.tab.hh" // lalr1.cc:395
  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        CONFIG_MITCHELL = 287,
        CONFIG_LANCZOS = 288,
        CONFIG_UNFILTERED = 289,
        CONFIG_TRILINEAR = 290,
        CONFIG_EWA = 291,
        CONFIG_VAL_0 = 292,
        CONFIG_VAL_1 = 293,
        CONFIG_SHAPE = 294,
        ...
        CONFIG_COLOR = 302,
        CONFIG_MATERIAL = 303,
        CONFIG_DUALMATERIAL = 304,
        CONFIG_TEXTURE = 305,
        CONFIG_ANISOTROPY = 306,
        CONFIG_BECKMANN = 307,
        CONFIG_BLINN = 308,
        CONFIG_DIFFUSE = 309,
        CONFIG_DISTRIBUTION = 310,
        CONFIG_ELEM = 311,
        CONFIG_GGX = 312,
        CONFIG_GLASS = 313,
        CONFIG_GLOSSY = 314,
        ...
        CONFIG_PLATINUM = 343,
        CONFIG_TUNGSTEN = 344,
        CONFIG_BERYLLIUM = 345,
        CONFIG_BISMUTH = 346,
        CONFIG_COBALT = 347,
        CONFIG_CHROMIUM = 348,
        CONFIG_GERMANIUM = 349,
        CONFIG_POTASSIUM = 350,
        CONFIG_LITHIUM = 351,
        CONFIG_MAGNESIUM = 352,
        CONFIG_MANGANESE = 353,
        CONFIG_MOLYBDENUM = 354,
        CONFIG_SODIUM = 355,
        CONFIG_NIOBIUM = 356,
        CONFIG_NICKEL = 357,
        CONFIG_PALLADIUM = 358,
        CONFIG_RHODIUM = 359,
        CONFIG_TANTALUM = 360,
        CONFIG_TITANIUM = 361,
        CONFIG_VANADIUM = 362,
        CONFIG_ZINC = 363,
        CONFIG_ZIRCONIUM = 364,
        CONFIG_UINT = 365,
        CONFIG_INT = 366,
        CONFIG_FLOAT = 367,
        CONFIG_STRING = 368
  ...
  basic_symbol (typename Base::kind_type t, const unsigned int& v, const location_type& l);
    ...
    static inline
    symbol_type
    make_UNFILTERED (const location_type& l);

    static inline
    symbol_type
    make_TRILINEAR (const location_type& l);

    static inline
    symbol_type
    make_EWA (const location_type& l);
    ...
    static inline
    symbol_type
    make_DUALMATERIAL (const location_type& l);
    ...
    static inline
    symbol_type
    make_CHNR (const location_type& l);

    static inline
    symbol_type
    make_CHNG (const location_type& l);

    static inline
    symbol_type
    make_CHNB (const location_type& l);

    static inline
    symbol_type
    make_CHNA (const location_type& l);
    ...
    static inline
    symbol_type
    make_RADIUS (const location_type& l);

    static inline
    symbol_type
    make_FALLOFF (const location_type& l);

    static inline
    symbol_type
    make_OMNI (const location_type& l);

    static inline
    symbol_type
    make_SPOT (const location_type& l);

    static inline
    symbol_type
    make_AREA (const location_type& l);
    ...
    static inline
    symbol_type
    make_BERYLLIUM (const location_type& l);

    static inline
    symbol_type
    make_BISMUTH (const location_type& l);

    static inline
    symbol_type
    make_COBALT (const location_type& l);

    static inline
    symbol_type
    make_CHROMIUM (const location_type& l);

    static inline
    symbol_type
    make_GERMANIUM (const location_type& l);

    static inline
    symbol_type
    make_POTASSIUM (const location_type& l);

    static inline
    symbol_type
    make_LITHIUM (const location_type& l);

    static inline
    symbol_type
    make_MAGNESIUM (const location_type& l);

    static inline
    symbol_type
    make_MANGANESE (const location_type& l);

    static inline
    symbol_type
    make_MOLYBDENUM (const location_type& l);

    static inline
    symbol_type
    make_SODIUM (const location_type& l);

    static inline
    symbol_type
    make_NIOBIUM (const location_type& l);

    static inline
    symbol_type
    make_NICKEL (const location_type& l);

    static inline
    symbol_type
    make_PALLADIUM (const location_type& l);

    static inline
    symbol_type
    make_RHODIUM (const location_type& l);

    static inline
    symbol_type
    make_TANTALUM (const location_type& l);

    static inline
    symbol_type
    make_TITANIUM (const location_type& l);

    static inline
    symbol_type
    make_VANADIUM (const location_type& l);

    static inline
    symbol_type
    make_ZINC (const location_type& l);

    static inline
    symbol_type
    make_ZIRCONIUM (const location_type& l);
  ...
  ConfigParser::symbol_type
  ConfigParser::make_UNFILTERED (const location_type& l)
  {
    return symbol_type (token::CONFIG_UNFILTERED, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_TRILINEAR (const location_type& l)
  {
    return symbol_type (token::CONFIG_TRILINEAR, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_EWA (const location_type& l)
  {
    return symbol_type (token::CONFIG_EWA, l);
  }
  ...
  ConfigParser::symbol_type
  ConfigParser::make_SHIFT (const location_type& l)
  {
    return symbol_type (token::CONFIG_SHIFT, l);
  }
  ...
  ConfigParser::symbol_type
  ConfigParser::make_DUALMATERIAL (const location_type& l)
  {
    return symbol_type (token::CONFIG_DUALMATERIAL, l);
  }
  ...
  ConfigParser::symbol_type
  ConfigParser::make_CHNR (const location_type& l)
  {
    return symbol_type (token::CONFIG_CHNR, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_CHNG (const location_type& l)
  {
    return symbol_type (token::CONFIG_CHNG, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_CHNB (const location_type& l)
  {
    return symbol_type (token::CONFIG_CHNB, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_CHNA (const location_type& l)
  {
    return symbol_type (token::CONFIG_CHNA, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_INV (const location_type& l)
  {
    return symbol_type (token::CONFIG_INV, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_MASK (const location_type& l)
  {
    return symbol_type (token::CONFIG_MASK, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_FIRST (const location_type& l)
  {
    return symbol_type (token::CONFIG_FIRST, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_SECOND (const location_type& l)
  {
    return symbol_type (token::CONFIG_SECOND, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_RADIUS (const location_type& l)
  {
    return symbol_type (token::CONFIG_RADIUS, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_FALLOFF (const location_type& l)
  {
    return symbol_type (token::CONFIG_FALLOFF, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_OMNI (const location_type& l)
  {
    return symbol_type (token::CONFIG_OMNI, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_SPOT (const location_type& l)
  {
    return symbol_type (token::CONFIG_SPOT, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_AREA (const location_type& l)
  {
    return symbol_type (token::CONFIG_AREA, l);
  }
  ...
  ConfigParser::symbol_type
  ConfigParser::make_BERYLLIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_BERYLLIUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_BISMUTH (const location_type& l)
  {
    return symbol_type (token::CONFIG_BISMUTH, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_COBALT (const location_type& l)
  {
    return symbol_type (token::CONFIG_COBALT, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_CHROMIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_CHROMIUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_GERMANIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_GERMANIUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_POTASSIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_POTASSIUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_LITHIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_LITHIUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_MAGNESIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_MAGNESIUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_MANGANESE (const location_type& l)
  {
    return symbol_type (token::CONFIG_MANGANESE, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_MOLYBDENUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_MOLYBDENUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_SODIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_SODIUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_NIOBIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_NIOBIUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_NICKEL (const location_type& l)
  {
    return symbol_type (token::CONFIG_NICKEL, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_PALLADIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_PALLADIUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_RHODIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_RHODIUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_TANTALUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_TANTALUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_TITANIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_TITANIUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_VANADIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_VANADIUM, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_ZINC (const location_type& l)
  {
    return symbol_type (token::CONFIG_ZINC, l);
  }

  ConfigParser::symbol_type
  ConfigParser::make_ZIRCONIUM (const location_type& l)
  {
    return symbol_type (token::CONFIG_ZIRCONIUM, l);
  }
...
#line 2345 "config_parser.tab.hh" // lalr1.cc:395

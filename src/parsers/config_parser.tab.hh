  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        CONFIG_MATERIAL = 303,
        CONFIG_TEXTURE = 304,
        CONFIG_ANISOTROPY = 305,
        CONFIG_BECKMANN = 306,
        CONFIG_BLINN = 307,
        CONFIG_DIFFUSE = 308,
        CONFIG_DISTRIBUTION = 309,
        CONFIG_ELEM = 310,
        CONFIG_GGX = 311,
        CONFIG_GLASS = 312,
        CONFIG_GLOSSY = 313,
        ...
        CONFIG_MATTE = 315,
        CONFIG_METAL = 316,
        CONFIG_ROUGHNESS = 317,
        CONFIG_SPECULAR = 318,
        CONFIG_SRC = 319,
        CONFIG_PATH_TRACE = 320,
        CONFIG_CHNR = 321,
        CONFIG_CHNG = 322,
        CONFIG_CHNB = 323,
        CONFIG_CHNA = 324,
        ...
        CONFIG_PLATINUM = 334,
        CONFIG_TUNGSTEN = 335,
        CONFIG_BERYLLIUM = 336,
        CONFIG_BISMUTH = 337,
        CONFIG_COBALT = 338,
        CONFIG_CHROMIUM = 339,
        CONFIG_GERMANIUM = 340,
        CONFIG_POTASSIUM = 341,
        CONFIG_LITHIUM = 342,
        CONFIG_MAGNESIUM = 343,
        CONFIG_MANGANESE = 344,
        CONFIG_MOLYBDENUM = 345,
        CONFIG_SODIUM = 346,
        CONFIG_NIOBIUM = 347,
        CONFIG_NICKEL = 348,
        CONFIG_PALLADIUM = 349,
        CONFIG_RHODIUM = 350,
        CONFIG_TANTALUM = 351,
        CONFIG_TITANIUM = 352,
        CONFIG_VANADIUM = 353,
        CONFIG_ZINC = 354,
        CONFIG_ZIRCONIUM = 355,
        CONFIG_UINT = 356,
        CONFIG_INT = 357,
        CONFIG_FLOAT = 358,
        CONFIG_STRING = 359

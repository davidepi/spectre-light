  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        CONFIG_PLATINUM = 328,
        CONFIG_TUNGSTEN = 329,
        CONFIG_BERYLLIUM = 330,
        CONFIG_BISMUTH = 331,
        CONFIG_COBALT = 332,
        CONFIG_CHROMIUM = 333,
        CONFIG_GERMANIUM = 334,
        CONFIG_POTASSIUM = 335,
        CONFIG_LITHIUM = 336,
        CONFIG_MAGNESIUM = 337,
        CONFIG_MANGANESE = 338,
        CONFIG_MOLYBDENUM = 339,
        CONFIG_SODIUM = 340,
        CONFIG_NIOBIUM = 341,
        CONFIG_NICKEL = 342,
        CONFIG_PALLADIUM = 343,
        CONFIG_RHODIUM = 344,
        CONFIG_TANTALUM = 345,
        CONFIG_TITANIUM = 346,
        CONFIG_VANADIUM = 347,
        CONFIG_ZINC = 348,
        CONFIG_ZIRCONIUM = 349,
        CONFIG_UINT = 350,
        CONFIG_INT = 351,
        CONFIG_FLOAT = 352,
        CONFIG_STRING = 353

...
For every keys described in the [keyword](#keywords) seciont, the following values can be used where specified
...
material | [object](#material) or quoted string | Description of a material that will be put in the Material Library. The quoted string will chain another file to this one to be parsed, see section [Chained Files](#chained-files) for more information | -

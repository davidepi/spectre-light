...
public:
     ...
     */
    virtual Spectrum
    sample_visible_surface(float r0, float r1, const Point3* position,
            Vec3* wiW, float* pdf, float* distance) const = 0;
     ...
     *  \sa sample_visible_surface()
     */
    virtual float pdf(const Point3* p, const Vec3* wiW) const = 0;
